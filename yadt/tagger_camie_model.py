...
def load_model(model_dir, full=False, device='cpu', **kwargs):
    ...
    # Load weights
    state_dict_path = state_dict_path or os.path.join(model_dir, "model_refined.pt" if full else "model_initial_only.pt")
...
if __name__ == "__main__":
    ...
    for full in (False, True):
        ...
        if len(sys.argv) > 2:
            ...
            # Get tags
            tags = model.get_tags_from_predictions(results['predictions'], probabilities=results['refined_probabilities'])
